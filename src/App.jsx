...
const OB_SLIDES = [
  {
    ...
    extra: <div style={styles.bankCard}><div style={styles.bankLabel}>Your bankroll to get started</div><div style={styles.bankAmt}>$1,000.00</div></div>,
  },
  {
    icon: '🎁',
    ...
    extra: <div style={styles.obBox}><p>For example: deposit <strong>$50</strong> with TAB and they give you a <strong>$100 bonus bet</strong>. That's $150 to play with, but you only put in $50.</p></div>,
  },
  {
    icon: '⚠️',
    ...
    extra: <>
      <div style={styles.obBox}><p><strong>Rule 1:</strong> You can't withdraw a bonus bet. You must place it as a bet first before any money can leave the account.</p></div>
      <div style={{...styles.obBox, marginTop: 8}}><p><strong>Rule 2:</strong> If your bonus bet wins, you only receive the <strong>profit</strong> — not your original stake back. So the bigger the odds, the bigger the profit.</p></div>
    </>,
  },
  {
    icon: '🛡️',
    ...
    extra: <div style={styles.obBox}><p>One of those bets always wins. So no matter what happens, <strong>you always get paid</strong>. The risk is removed completely.</p></div>,
  },
  {
    icon: '📸',
    ...
    extra: <div style={styles.obBox}><p>Screenshot the odds board from any bookie app. The tool reads it, finds the best game, and tells you <strong>exactly what to bet and where</strong>.</p></div>,
  },
]
